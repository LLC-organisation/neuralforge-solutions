    ...
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium px-4 py-2 rounded-md transition-colors"
        >
          <Plus size={15} />
          New Case Study
        </Link>
            ...
            >
              ...
              <div className="flex items-center gap-2 shrink-0">
                <form action={toggleCaseStudyPublished.bind(null, study.id, !study.published)}>
                  <button
                    type="submit"
                    className="text-xs text-zinc-400 hover:text-blue-500 px-3 py-1.5 rounded border border-zinc-700 hover:border-blue-500/50 transition-colors"
                  >
